...
\begin{itemize}
  ...
  \item System tests are very limited
\end{itemize}
...
\begin{itemize}
\item \texttt{test/running/test_main.sh} - Main test script, runs the program with specified arguments and input, and compares it against what was expected.
